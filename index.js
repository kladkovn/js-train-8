...
function removeLastElement(arr) {
  Array.isArray();
  arr.pop();
  console.log (arr);// Перевіряємо, чи масив не є порожнім, якщо порожній повертаємо  undefined
...
function combineAndReverseArrays(arr1, arr2) {
  console.log(Array.isArray(arr1, arr2));
...
console.log(arr.indexOf(element), arr.lastIndexOf(element));
